...
public final class ProductDao_Impl implements ProductDao {
  ...
  @Override
  public Object insert(final ProductEntity[] product,
  ...
  @Override
  public Object delete(final ProductEntity product, final Continuation<? super Unit> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        __db.beginTransaction();
  ...
  @Override
  public Object update(final ProductEntity[] product,
      final Continuation<? super Unit> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
