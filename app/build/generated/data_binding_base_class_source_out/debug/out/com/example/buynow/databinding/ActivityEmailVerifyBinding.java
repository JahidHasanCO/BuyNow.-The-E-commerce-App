...
public final class ActivityEmailVerifyBinding implements ViewBinding {
  ...
  public static ActivityEmailVerifyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageView imageEmailVerifyPage = rootView.findViewById(id);
      ...
      TextView msgEmailVerifyPage = rootView.findViewById(id);
      if (msgEmailVerifyPage == null) {
        break missingId;
      }

      id = R.id.reSendEmail_emailVerifyPage;
      TextView reSendEmailEmailVerifyPage = rootView.findViewById(id);
      if (reSendEmailEmailVerifyPage == null) {
        break missingId;
      }

      id = R.id.title_emailVerifyPage;
      TextView titleEmailVerifyPage = rootView.findViewById(id);
      if (titleEmailVerifyPage == null) {
        break missingId;
      }

      id = R.id.tryAgain_emailVerifyPage;
      Button tryAgainEmailVerifyPage = rootView.findViewById(id);
